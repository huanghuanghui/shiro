...
import com.hhh.shirospringboot.util.common.HexConvertUtil;
...
public class AesCipherUtil {
  ...
  public static String enCrypto(String str){
    try {
      ...
      secureRandom.setSeed(Base64ConvertUtil.decode(Constant.AES_SEED).getBytes());
  ...
  public static void main(String[] args) {
    System.out.println(AesCipherUtil.enCrypto("123456"));
  }
}

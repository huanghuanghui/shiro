...
import com.hhh.shirospringboot.config.shiro.cache.CustomCacheManager;
import com.hhh.shirospringboot.config.shiro.jwt.JwtFilter;
...
public class ShiroConfig {
  ...
  public ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager) {
    ...
    // 公开接口
     filterChainDefinitionMap.put("/anon-api/**", "anon");
    // 登录接口放开
